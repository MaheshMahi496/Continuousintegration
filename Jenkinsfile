...
node {
   ...
   stage('Check out the code from Git Repository') {// for display purposes
      ...
      url: 'https://github.com/MaheshMahi496/Continuousintegration.git'
  ...
  stage('SONAR Analysis') {
   ...
   stage('Function Test Cases execution') {
      ...
      if (isUnix()) {
         ...
         SoapUIPro(environment: '', pathToProjectFile: 'D:/CI/testScripts/CT-readyapi-project.xml', pathToTestrunner: 'C:/Program Files/SmartBear/ReadyAPI-2.7.0/bin/testrunner.bat', projectPassword: '', testCase: '', testSuite: '')
   ...
   if (currentBuild.currentResult == 'SUCCESS') {
        stage('Success') {
            ...
            emailext (
                ...
                to: "mahesh.rasakonda@whishworks.com,naresh.manthrabuddi@whishworks.com",
